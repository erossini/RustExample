...
// Creates a module
// Contains other modules which hold functions, structs, enums, constants, traits

// You use modules to organize your code and to make parts of it private (Everything is Private by Default)

// Parent modules can't access private items in child modules but children can always access parent items

mod pizza_order {

    // To access the struct and the part to make public must both use pub
    #[derive(Debug)] // So that we can print out a Pizza
    pub struct Pizza {
        pub dough: String,
        pub cheese: String,
        pub topping: String,
    ...
    pub mod help_customer {
        ...
        fn seat_at_table() {
            println!("Customer is now seated at a table");
        }
        ...
        pub fn take_order() {
            ...
            println!("Order taken for {:#?}", cust_pizza);
